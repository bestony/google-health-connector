...
This file is the source of truth for local setup, database dialects,
authentication, Google Health authorization, legal pages, API keys, and the
MCP server. The product overview is in [`README.md`](README.md). Deploy
guides are in [`deployment/`](deployment/README.md).
...
Production builds and host-specific deploy steps live in
...
states described in the `e2e/` suite.
